    ...
    return (
        <Style>
            <GuidePanel poster="true">
                ...
                <BodyShort spacing>
                    Hvis du skal ettersende dokumentasjon til denne
                    søknaden må det sendes inn på papir.
                </BodyShort>
                <HorizontalLinksFlexbox>
                    <BodyShort spacing>
                        <a href="https://www.dev.nav.no/minside/">
                            Du finner søknaden du sendte inn på min
                            side på nav.no
                        </a>
                    </BodyShort>
                    <BodyShort spacing>
                ...
                <BodyShort spacing>
                    Viss du skal ettersende dokumentasjon til denne
                    søknaden må det sendast inn på papir.
                </BodyShort>
                <HorizontalLinksFlexbox>
                    <BodyShort spacing>
                        <a href="https://www.dev.nav.no/minside/">
                            Du finn søknaden du sendte inn på mi side
                            på
                        </a>
                    </BodyShort>
                    <BodyShort spacing>
                ...
                <Heading level="1" size="xlarge" spacing>
                    You have tried to reopen an application that has
                    already been sent to NAV
                </Heading>
                <BodyShort spacing>
                    If you want to submit additional documentation to
                    this application, it must be sent in on paper.
                </BodyShort>
                <HorizontalLinksFlexbox>
                    <BodyShort spacing>
                        <a href="https://www.dev.nav.no/minside/">
                    ...
                    <BodyShort spacing>
                        <a href="https://www.nav.no/soknader/nn/ettersendelse/person">
                            ...
                            previously submitted on my page on nav.no
                        </a>
                    </BodyShort>
                </HorizontalLinksFlexbox>
