...
describe('Tester dokumentinnsendingsløpet', () => {
    it('Går igjennom fra åpning av url som oppretter søknad til kvitteringssiden', () => {
        ...
        cy.get;
        cy.visit(
            'http://localhost:3000/opprettSoknadResource?skjemanummer=NAV%2054-00.04&sprak=NO_NB&erEttersendelse=false&vedleggsIder=C1,W1,G2',
        );

        cy.get('[data-cy="nesteStegKnapp"]', {
            timeout: 10000,
        }).should('be.visible');
